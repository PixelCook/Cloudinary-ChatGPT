...
import {getMongoQuery as _queryQ2M} from "./lib/query/q2m/index.mjs";
import {validate as _validateYup, cast as _castYup, prepare as _prepareYup} from "./lib/schema/yup/index.mjs";
import {validate as _validateJSON, cast as _castJSON, prepare as _prepareJSON} from "./lib/schema/json-schema/index.mjs";
import {validate as _validateZod, cast as _castZod, prepare as _prepareZod }  from "./lib/schema/zod/index.mjs";
...
async function updateFunc(req, res) {
    ...
    try {
        ...
        console.log(req.headers['x-real-ip'], req.method, req.originalUrl, _schema[collection]);
        if (_schema[collection] != null) {
            _validate(_schema[collection], document, _opt)
                .then(async function (value) {
