...
function createRoute(str) {
  if(str instanceof RegExp) {
    // remove regex first and last slash /.*/
...
class Codehooks {
  ...
  render = async (view, data, cb) => {
    ...
    /*
    if (cb) {
      cb(null, {html: "<p>HELO</p>", view, data})
    }*/
  }
...
const _filestore = {
  /**
   * Get binary file input stream
   * @param {string} path to file, e.g. /static/logo.png 
   * @param {Object} options for future use
   * @returns Promise with a binary data stream emitter
   * @example 
   * app.get('/picture', async (req, res) => {
   *   const stream = await filestore.getFileStream('/static/logo.png')
   ...
   *   const file = await filestore.readFile('/static/home.html');
   ...
   * @param {string} path Abolute path to file, e.g. /static/home.html 
   * @param {Object} options File meta data, e.g. {"content-type": "text/html"}
  ...
  /**
   * List content of a file directory
   * @param {string} path Absolute path to file
   * @param {Object} options For future use
   * @returns Promise with result
   */
